...
public class WiimotePanel extends JPanel {
    ...
    ImageIcon current = new ImageIcon("WiiMote_released.png");
	ImageIcon released = new ImageIcon("WiiMote_released.png");
	ImageIcon pressed2 = new ImageIcon("WiiMote_2_pressed.png");
	ImageIcon pressedA = new ImageIcon("WiiMote_A_pressed.png");
	ImageIcon pressedB = new ImageIcon("WiiMote_B_pressed.png");
	ImageIcon pressedHOME = new ImageIcon("WiiMote_HOME_pressed.png");
